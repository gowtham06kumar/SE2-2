...
public class StudentCourseDetailsImportScreen extends JFrame implements
		ActionListener {
	...
	public StudentCourseDetailsImportScreen() {
		setVisible(true);
		setLocation(400, 250);
		setSize(600, 400);
	...
	private void initComponents() {
		...
		label1 = new JLabel(
				"Choose a file to import Student completed course details...");
		panel1.add(label1);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == showFileDialogButton) {
			...
			dispose();
			List<StudentCourse> studentCourseList = StudentCoursesDM
			...
			dtm.addColumn("CompletedCourses");
			dtm.addColumn("CourseProgress");

			for (int i = 0; i < studentCourseList.size(); i++) {
				Student student = studentCourseList.get(i).getStudent();
				dtm.addRow(new Object[] { student.getId(), student.getDegreeCode(),
						student.getSemester(),
						studentCourseList.get(i).getCourse(),
						studentCourseList.get(i).getGrade() });
			}
