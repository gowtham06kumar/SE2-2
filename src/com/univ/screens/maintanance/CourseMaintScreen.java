...
public class CourseMaintScreen extends JFrame {
	...
	public CourseMaintScreen() {
	}

	public CourseMaintScreen(List<Course> cList) {
		setVisible(true);
		setLocation(400, 250);
		...
		dtm.addColumn("creditHours");
		dtm.addColumn("capacity");

		for (Course course : courseList) {
			System.out.println(course.toString());
			dtm.addRow(new Object[] { course.getCode(), course.getName(),
					course.getDescription(), course.getCreditHours(),
					course.getClassCapacity() });
		}
		...
		JLabel lblNewLabel_2 = new JLabel("Course Capacity");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!textField.getText().trim().equals("")) {
					...
					MenuScreen.courseList = CourseDM_old.getListfromTable(dtm);
				} else
