...
public class FacultyReportDisplayScreen extends JFrame{

	public List<Schedule> scheduleList;
	private static final long serialVersionUID = 4406724596143778906L;
	private JPanel contentPane;
	private JTable table_1;
	public FacultyReportDisplayScreen(){}
	public FacultyReportDisplayScreen(Map<String,Integer> hm){
		setVisible(true);
		setLocation(400,250);
		...
		dtm.addColumn("Faculty Name");
		dtm.addColumn("Faculty Load");
